        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PlayerId = table.Column<string>(nullable: true),
                    PlayerName = table.Column<string>(nullable: true),
                    TeeBoxPlayed = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CourseHole_Courses_CourseId",
                        column: x => x.CourseId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    CourseId = table.Column<int>(nullable: true),
                    CourseRating = table.Column<decimal>(nullable: false),
                    Name = table.Column<string>(nullable: true),
                    SlopeRating = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                    HoleNumber = table.Column<int>(nullable: false),
                    HolePutt = table.Column<int>(nullable: false),
                    HoleScore = table.Column<int>(nullable: false),
                    RoundOfGolfId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScoreGolf", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScoreGolf_RoundsOfGolf_RoundOfGolfId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScoreGolf_RoundOfGolfId",
                table: "ScoreGolf",
